...
# ==================================================
# Link Hosting Kalian
"http://github.com/IlhamStore23/SCVPS/main/wireguard"
...
echo -e "${Info} Wireguard Script Mod By Ilham Store"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/IlhamStore23/SCVPS/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/IlhamStore23/SCVPS/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/IlhamStore23/SCVPS/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd

...
echo "Checking VPS"
# Link Hosting Kalian
"https://github.com/IlhamStore23/SCVPS/main/backup"

apt install rclone -y
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/IlhamStore23/SCVPS/main/backup/rclone.conf"
git clone  https://github.com/IlhamStore23/wondershaper.git
cd wondershaper
make install
cd
rm -rf wondershaper
